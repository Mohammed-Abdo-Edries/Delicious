    ...
    <div className="carousel" id="carousel">
        ...
        <div className="meal-text">
            ...
            <div className="container">
              <div className="insade" data-aos="flip-left" data-aos-duration="1500">
                <h3 className="first inside-title"><TbInfinity className="logo" /> UP TO 365 DAYS/YEAR</h3>
                <div className="insade-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia explicabo voluptates at!</div>
              </div>
              <div className="insade" data-aos="flip-left" data-aos-duration="1500">
              ...
              <div className="insade" data-aos="flip-left" data-aos-duration="1500">
                ...
                <div className="insade-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit eaque quidem consequatur corrupti, quod vero?</div>
              </div>
              <div className="insade" data-aos="flip-left" data-aos-duration="1500">
